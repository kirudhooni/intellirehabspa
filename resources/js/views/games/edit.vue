<template>
<div>
    <h2 class="display-4 form-label-mb-5">Edit Game</h2>
...
<script>
    ...
    export default {
        ...
        created(){
            axios.get(`/api/games/edit/${this.$route.params.id}`,{
                headers: {
        ...
        methods:{
                submitForm(){
                    ...
                    axios.post(`/api/games/edit/update/${this.$route.params.id}`, formData,{
                        headers: {
                            "Authorization": `Bearer ${this.$store.state.currentUser.token}`,
